...
hexo.extend.helper.register('raw_link', (path) => `https://github.com/learning-english/site/edit/main/source/${path}`);
...
hexo.extend.helper.register('canonical_path_for_nav', function() {
  ...
  if (path.startsWith('tenses/')) return path;
  return '';
});
